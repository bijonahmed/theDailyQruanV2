...
<html>
    <head>
    	...
    	<title>w3programmer Sandbox</title>
    	<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<link rel="icon" href="https://w3programmer.net/assets/images/logo/site_logo.png" type="image/x-icon">
        ...
        <ul class="w3-light-grey">
        	<li class="dropdown">
        		...
        		<div class="dropdown-content" id="about" onmouseover='mouseover_about=true;' onmouseleave='mouseover_about=false;if(blur_about){$Id("about").classList.remove("show")}'>
        			<p><b>About:</b></p>
        			<p><a href="https://w3programmer.net/">w3programmer.net</a></p>
