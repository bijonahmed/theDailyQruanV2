...
class ProductController extends Controller
{
    ...
    public function dashboardCounting()
    {
        ...
        $today = Carbon::today(); // Uses Laravel timezone// date("Y-m-d");
        $data['today_deposit']  = Deposit::whereDate('created_at', $today)->sum('deposit_amount');
        $data['total_service']  = Service::where('status', 1)->count();
