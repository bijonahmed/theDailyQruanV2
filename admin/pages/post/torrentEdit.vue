                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/post/torrentlist">Back to List</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <div class="tab-pane fade active show" id="custom-tabs-three-home"
                                                ...
                                                <div class="row mb-3 required">
                                                    <label for="input-name-1"
                                                        class="col-sm-2 col-form-label required-label">Title</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="row mb-3 required">
                                                    <label for="input-name-1"
                                                        class="col-sm-2 col-form-label required-label">Source</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="site_name" placeholder="Source"
                                                            v-model="insertdata.site_name" class="form-control" />
                                                        <input type="hidden" name="id" id="id" class="form-control" />
                                                        <span class="text-danger" v-if="errors.site_name">{{
                                                            errors.site_name[0] }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3 required">
                                                    <label for="input-meta-title-1" class="col-sm-2 col-form-label">Meta
                                                        Tag Title</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="meta_title" value
                                                            placeholder="Meta Tag Title" id="meta_title"
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea name="meta_keyword" rows="5" id="meta_keyword"
                                                            class="form-control" v-model="insertdata.meta_keyword"
                                                            placeholder="Meta Tag Keywords"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="alert alert-info" bis_skin_checked="1">
                                                    <i class="fas fa-info-circle"></i>Torrent
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="input-meta-description-1"
                                                        class="col-sm-2 col-form-label">Torrent File</label>
                                                    <div class="col-sm-10">
                                                        <input type="file" value class="form-control" id="fileInput"
                                                            accept=".torrent,application/x-bittorrent" ref="files"
...
const saveData = () => {
    ...
    formData.append('site_name', insertdata.site_name);
    ...
    axios.post('/post/TorrentUpdate', formData, {
        headers: {
        ...
        $('#formrest')[0].reset();
        success_noti();
        const torrentId = res.data.torrentId;
        // Redirect to product variant page
        router.push({
            path: '/post/torrentlist',
            query: {
                parameter: torrentId
            }
        });
...
const productrow = () => {
    ...
    axios.get(`/post/postTorrentRow/${id}`).then(response => {
        ...
        if (summernoteEditorFull.value) {
            ...
            editor.summernote('code', response.data.data.description);
        }
