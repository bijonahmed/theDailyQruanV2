                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/post/addTorrent">New</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            ...
                                            <tbody>
                                                <tr v-for="item in productdata" :key="item.id">
                                                    ...
                                                    <td class="text-left"><a :href="item.download_link" target="_blank"
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/post/allTorrentFiles`, {
            params: {
                page: page,
                pageSize: pageSize,
