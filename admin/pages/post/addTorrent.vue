                    ...
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                      <div class="tab-pane fade active show" id="custom-tabs-three-home" role="tabpanel"
                        ...
                        <!-- General  -->
                         ...
                         <div class="row mb-3">
                          <label for="input-meta-description-1" class="col-sm-2 col-form-label">Torrent File</label>
                          <div class="col-sm-10">
                            <input type="file" value class="form-control" id="fileInput"
                              accept=".torrent,application/x-bittorrent" ref="files" @change="onFileSelected" />
                        ...
                        <div class="row mb-3 required">
                         ...
                         <div class="row mb-3 required">
                          <label for="input-name-1" class="col-sm-2 col-form-label required-label">Source</label>
                          <div class="col-sm-10">
                            <input type="text" name="site_name" placeholder="Source" v-model="insertdata.site_name"
                              class="form-control" />
                            <input type="hidden" name="id" id="id" class="form-control" />
                            <span class="text-danger" v-if="errors.site_name">{{ errors.site_name[0] }}</span>
                          </div>
                        </div>
...
const onFileSelected = (event) => {
  ...
  if (file.value) {
    ...
    // Remove the ".torrent" extension
    const nameWithoutExtension = fullName.replace(/\.torrent$/i, '');
    insertdata.name = nameWithoutExtension;
    insertdata.meta_title = nameWithoutExtension;
    insertdata.meta_description = nameWithoutExtension;
    insertdata.meta_keyword = nameWithoutExtension;
  }
};
...
const saveData = () => {
  ...
  axios.post('/post/addTorrent', formData, {
    headers: {
