                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/service/add">New</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <button type="button"><i class="fas fa-edit"
                                                                    ...
                                                                    <a v-if="item.pdf_file" class="btn btn-primary" :href="item.pdf_file" target="_blank">View PDF</a>
                                                        </center>
                                                    </td>
                                                </tr>
                                            </tbody>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/post/allServices`, {
            params: {
                page: page,
                pageSize: pageSize,
