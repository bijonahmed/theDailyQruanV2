<template>
    <title>ePdf Category List</title>
    <div>
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/setting/ePdf/add">New</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/category/ePdfCategoryes`, {
            params: {
                page: page,
                pageSize: pageSize,
...
const edit = (id) => {
    router.push({
        path: '/setting/ePdf/ePdf-category-edit',
        query: {
            parameter: id
        }
    });
