                  ...
                  <div class="card-body">
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                      <div class="tab-pane fade active show" id="custom-tabs-three-home" role="tabpanel"
                        ...
                        <div class="row mb-3">
                          <label for="input-description-1" class="col-sm-2 col-form-label">Tutorial</label>
                          <div class="col-sm-10">
...
onMounted(() => {
  ...
  window.$(summernoteEditorFull.value).summernote({
    height: 200,
    callbacks: {
      onChange: (contents) => {
        tutorialContent.value = contents
      }
    }
  })
})
...
const saveData = () => {
  ...
  const content = $(summernoteEditorFull.value).summernote('code')
  tutorialContent.value = content
  //console.log('===', tutorialContent.value)
  //  console.log("===" + tutorialContent.value);
  ...
  formData.append('tutorialContent', tutorialContent.value);
...
const categoryrow = () => {
  ...
  axios.get(`/category/categoryRow/${category_id}`).then(response => {
    // console.log("====" + response.data.data.tutorial_content);
    //return false; 
    ...
    //  tutorialContent.value = response.data.data.tutorial_content ? response.data.data.tutorial_content : "";
    ...
    if (summernoteEditorFull.value) {
      ...
      editor.summernote('code', response.data.data.tutorial_content);
    }
